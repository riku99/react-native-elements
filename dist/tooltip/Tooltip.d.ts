...
declare const _default: React.FunctionComponent<Pick<{
    ...
    closeOnlyOnBackdropPress: boolean;
    backDropPressDisabled: boolean;
} & Partial<ThemeProps<TooltipProps>>, "width" | "height" | "backgroundColor" | "containerStyle" | "overlayColor" | "ModalComponent" | "toggleOnPress" | "toggleAction" | "onOpen" | "withPointer" | "popover" | "pointerColor" | "onClose" | "withOverlay" | "highlightColor" | "skipAndroidStatusBar" | "closeOnlyOnBackdropPress" | "backDropPressDisabled">> | React.ForwardRefExoticComponent<{
    withPointer?: boolean;
    popover?: React.ReactElement<{}, string | ((props: any) => React.ReactElement<any, string | any | (new (props: any) => React.Component<any, any, any>)>) | (new (props: any) => React.Component<any, any, any>)>;
    toggleOnPress?: boolean;
    toggleAction?: string;
